...
# Dateipfade
file_path_fast = './sasa_comparison_FAST.xlsx'
file_path_wt = './sasa_comparison_WT.xlsx'
...
axes[0].set_ylabel(r"Solvent-accessible surface area (nm$^2$)", fontsize=10)
...
plt.savefig("sasa_Comparison_Combined.png", dpi=1000, bbox_inches='tight')
plt.show()
