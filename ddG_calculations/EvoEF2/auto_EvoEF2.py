...
def repair_pdb(input_pdb, output_folder):
    repair_command = f"/home/cornel/Documents/EvoEF2/EvoEF2 --command=RepairStructure --pdb={input_pdb}"
...
def compute_stability(input_pdb):
    stability_command = f"/home/cornel/Documents/EvoEF2/EvoEF2 --command=ComputeStability --pdb={input_pdb}"
